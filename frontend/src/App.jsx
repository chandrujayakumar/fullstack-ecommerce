    ...
    <Router>
      ...
      <div className='mt-[87px]'>
        <Routes>
          ...
          <Route exact path='/restricted-access/admin/login' element={isAdminAuthenticated ? <Navigate to="/restricted-access/admin/dashboard" /> : <Login />} />
          <Route exact path='/restricted-access/admin/dashboard' element={isAdminAuthenticated ? <Dashboard /> : <Navigate to="/" />} />
